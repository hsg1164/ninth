...
const Support: React.FC = () => {
  return (
    <div className="space-y-12">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold mb-4">الدعم الفني والتواصل الاجتماعي</h1>
        <p className="text-md sm:text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-3xl">
            روابط هامة للتواصل مع إدارة المدرسة والحصول على الدعم الفني اللازم.
        </p>
        <LinkGroupCard group={supportResource} />
      </div>
    </div>
  );
};
